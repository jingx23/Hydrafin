...
internal enum L10n {
  ...
  internal static let playerMpvDescription = L10n.tr("Localizable", "playerMpvDescription", fallback: "Best codec compatibility, accurate HDR, and recovers from imperfect streams. No Dolby Atmos or DTS-HD bitstream passthrough — multichannel PCM only.")
